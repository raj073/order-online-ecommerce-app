    ...
    <div className="font-primary">
      <div className="p-8 lg:w-1/2 mx-auto shadow-2xl">
        <div className="bg-white rounded-t-lg p-4">
          <p className="mt-14 text-center text-lg text-gray-800 font-medium">
            Sign up with
          </p>
          <div>
        ...
        <div className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-500 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-500">
          <p className="mx-4 mb-0 text-center font-semibold text-slate-800">
            OR
          </p>
        </div>
        <div className="bg-blue-100 rounded-b-lg py-4 px-4 lg:px-24">
          ...
          <form onSubmit={handleSignUp} className="mt-4">
            ...
            <div className="flex items-center justify-center mt-8">
              {" "}
              <button className="text-white py-2 px-4 uppercase rounded bg-indigo-500 hover:bg-indigo-800 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5 w-full">
                {" "}
                Sign up{" "}
              </button>{" "}
            </div>
